<div class="container">
  <div class="row">
    ...
    <table>
      <tr><td colspan="7" align="center"><a href="?page=tableau_pliage&mois=<?php echo $num_mois-1; ?>&amp;annee=<?php echo $num_an; ?>"><<</a>&nbsp;&nbsp;<?php echo $tab_mois[$num_mois];  ?>&nbsp;&nbsp;<a href="?page=tableau_pliage&mois=<?php echo $num_mois+1; ?>&amp;annee=<?php echo $num_an; ?>">>></a></td></tr>
      <tr><td colspan="7" align="center"><a href="?page=tableau_pliage&mois=<?php echo $num_mois; ?>&amp;annee=<?php echo $num_an-1; ?>"><<</a>&nbsp;&nbsp;<?php echo $num_an;  ?>&nbsp;&nbsp;<a href="?page=tableau_pliage&mois=<?php echo $num_mois; ?>&amp;annee=<?php echo $num_an+1; ?>">>></a></td></tr>
      <?php
      echo'<tr>';
      for($i = 1; $i <= 7; $i++){
